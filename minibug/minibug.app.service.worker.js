...
/** @type {string} */
const CACHE_VERSION = '1749007236|16589028';
/** @type {string} */
const CACHE_PREFIX = 'minibug-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'minibug.app.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["minibug.app.html","minibug.app.js","minibug.app.offline.html","minibug.app.icon.png","minibug.app.apple-touch-icon.png","minibug.app.audio.worklet.js","minibug.app.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["minibug.app.wasm","minibug.app.pck"];
